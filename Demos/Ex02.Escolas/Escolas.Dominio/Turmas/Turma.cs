...
namespace Escolas.Dominio.Turmas
{
    ...
    {
        public Turma(string codigo, string descricao, IEnumerable<Horario> horarios, DateTime iniciaEm, DateTime terminaEm, decimal valorMensal, decimal descontoParaTurnoManha, decimal descontoParaTurnoTarde)
        {
            Codigo = codigo;
            Descricao = descricao;
            Horarios = horarios;
            ...
            DescontoParaTurnoManha = descontoParaTurnoManha;
            DescontoParaTurnoTarde = descontoParaTurnoTarde;
        }
        ...
        public decimal DescontoParaTurnoManha { get; }
        public decimal DescontoParaTurnoTarde { get; }
    }
